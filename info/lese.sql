...
--
-- Máquina: localhost
-- Data de Criação: 31-Maio-2016 às 18:22
...
(1, 3, '', 'A equipe de desenvolvimento informou que o desenho esta inadequado', '0', 10, 0),
(2, 3, '', 'Um dos desenvolvedores esta fazendo refatoração não-automatizada', '0', 5, 0),
(3, 3, '', 'A equipe de qualidade fez uma inspeção e identificou que o código não esta padronizado', '0', 10, 0),
(4, 3, '', 'Sua experiência e liderança motivaram a equipe de desenvolvimento', '1', 10, 0),
(5, 3, '', 'Um dos engenheiros de software pediu demissão', '0', 10, 0),
(6, 3, '', 'Um dos engenheiros de software esta doente (stress)', '0', 5, 0),
(7, 3, '', 'A equipe de desenvolvimento esta seguindo os idiomas de programação da linguagem escolhida', '1', 5, 0),
(8, 3, '', 'A equipe de desenvolvimento executou testes unitários, encontrou erros e já corrigiu!', '1', 5, 0),
(9, 4, '', 'A equipe de testes esta utilizando testes automatizados', '1', 5, 0),
(10, 4, '', 'A equipe de testes não esta fazendo testes-automatizados', '0', 5, 0),
(11, 4, '', 'Os testes que tem sido aplicados não abrangem todos os casos de uso do sistema', '0', 5, 0),
(12, 4, '', 'Você é um engenheiro certificado em testes de software', '1', 5, 0),
(13, 4, '', 'Que pena! Foi constatada má Qualidade de Testes', '0', 10, 0),
(14, 4, '', 'Uma politica de segurança não-crítica foi ignorada pela equipe de desenvolvimento', '0', 10, 0),
(15, 1, '', 'Não foi encontrado nenhum erro nos requisitos', '1', 5, 0),
(16, 1, '', 'A equipe de qualidade identificou incosistências entre os artefatos', '0', 5, 0),
(17, 1, '', 'Módulos incompativeis', '0', 5, 0),
(18, 1, '', 'A reunião para o levantamento de requisitos foi cancelado pelo cliente', '0', 10, 0),
(19, 1, '', 'A reunião de brainstorming com o cliente foi extremamente produtiva', '1', 10, 0),
(20, 1, '', 'Os questionários para levantamento de requisitos resolveram muitas dúvidas', '1', 5, 0),
(21, 1, '', 'Você não soube conduzir as entrevistas com o usuário e elas não foram produtivas', '0', 10, 0),
(22, 5, '', 'O sistema esta apresentando lentidão', '0', 10, 0),
(23, 5, '', 'O código do sistema está bem modularizado', '1', 5, 0),
(24, 5, '', 'O sistema foi desenvolvido pensando em máxima portabilidade', '1', 10, 0),
(25, 5, '', 'Benchmarks realizados sobre o sistema relatam ótimo desempenho geral', '1', 5, 0),
(26, 5, '', 'Muito código espaguete foi detectado no sistema de interesse, manutenção levará tempo', '0', 10, 0),
(27, 2, '', 'O tamanho do projeto foi mal estimado pelo engenheiro', '0', 5, 0),
(28, 2, '', 'O projeto de dados ficou confuso e precisou ser refeito', '0', 10, 0),
(29, 2, '', 'A prototipação deixou o cliente extremamente satisfeito e com boas expectativas', '1', 10, 0),
(30, 2, '', 'Sua proposta de projeto seguiu todos os padrões previstos pelo padrão Proposta de Especificação de Software', '1', 10, 0),
(31, 2, '', 'O projeto de software não levou em consideração as necessidades dos clientes', '0', 10, 0),
(32, 2, '', 'Sua proposta de projeto adquiriu aprovação em revisão gerencial', '1', 5, 0),
(33, 3, '', 'A equipe de desenvolvimento achou a especificação muito confusa e com ambiguidades.', '0', 5, 0),
(34, 3, '', 'A equipe de desenvolvimento utilizou reuso de código para implementação de um dos módulos do sistema.', '1', 10, 0),
(35, 4, '', 'A equipe de testes finalizou a homologação e não encontrou bugs críticos.', '1', 10, 0),
(36, 1, '', 'Você concluiu todos os diagramas de modelagem de requisitos.', '1', 5, 0),
(37, 1, '', 'A reunião para o levantamento de requisitos foi cancelado pelo cliente', '0', 5, 0),
(38, 5, '', 'O cliente identificou problemas nas interfaces', '0', 10, 0),
(39, 5, '', 'O Cliente informou que estão faltando requisitos. Isso é considerado um erro grave em um desenvolvimento de software.', '0', 10, 0),
(40, 2, '', 'O arquiteto concluiu os diagramas arquiteturais.', '1', 5, 0);
...
INSERT INTO `teacher` (`cpf`, `user`, `institution`, `email`, `password`) VALUES
('123456', 4, 'Universidade Federal de Minas Gerais', 'teste@teste.com', 'E10ADC3949BA59ABBE56E057F20F883E');
